...
loaded_clf_mh = load('../model/naive_bayes_mHealth.joblib')
loaded_clf_realworld = load('../model/naive_bayes_realworld.joblib')
loaded_clf_stu = load('../model/naive_bayes_stu.joblib')
