...
loaded_clf_mh = load('../model/random_forest_mHealth.joblib')
loaded_clf_realworld = load('../model/random_forest_realworld.joblib')
loaded_clf_stu = load('../model/random_forest_stu.joblib')
