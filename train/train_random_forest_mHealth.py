...
from datareader.mh_datareader import simple_get_mh_all_features, get_features
...
filtered_label = [0, 2, 3, 5, 6, 7, 8, 9, 10, 12]
...
# 保存模型到文件
dump(clf, '../model/random_forest_mHealth.joblib')
