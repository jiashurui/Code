...
from datareader.child_datareader import simple_get_child_2024_all_features, simple_get_child_2023_all_features
...
train_data = simple_get_child_2023_all_features(window_size, type='df')
